...
parser$add_argument(
  "-k", "--keys", nargs = "*", type = "character", default = "NA",
...
parser$add_argument(
  "-o", "--uniqOutput", nargs = 1, type = "character", default = "NA",
  help = "Output file for unique alignments. File types supported: .rds, .RData, .csv, and .tsv")
parser$add_argument(
  "--condSites", nargs = 1, type = "character", default = "NA", 
...
parser$add_argument(
  "--chimeras", nargs = 1, type = "character", default = "NA", 
  help = "Output file for chimeric alignments. Same file types supported as uniqOutput.")
parser$add_argument(
  "--multihits", nargs = 1, type = "character", default = "NA", 
...
}else if(length(args$keys) == 1 & args$keys != "NA"){
